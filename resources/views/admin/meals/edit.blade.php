...
@section('content')
    ...
    <div class="row justify-content-center mt-5">
        <div class="col-6">
            ...
            <form action="{{ route('admin.meals.update', ['meals' => $meals->slug]) }}" method="POST"
                ...
                {{-- Piatto Disponibile --}}
                <div>
                    <input class="form-check-input" type="checkbox" value="{{ old('available'), $meals->available }}"
